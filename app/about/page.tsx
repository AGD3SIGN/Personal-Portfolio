...
export const metadata = {
  title: "About Me | showcasy.",
  description: "Learn more about Ivan, a Visual Designer living in Munich with over 10 years of experience.",
}
        ...
        <div className="mx-auto max-w-[1400px] text-center">
          <ScrollReveal>
            <h1 className="mx-auto max-w-4xl text-balance text-5xl font-bold leading-[1.05] tracking-tight text-foreground md:text-7xl lg:text-[88px]">
              ...
              a Visual Designer living in Munich
            </h1>
          </ScrollReveal>
